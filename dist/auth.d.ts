declare global {
     ...
     */
    type AcceptInviteErrorCode = 'VALIDATION_FAILED' | 'EMAIL_ALREADY_MEMBER' | 'INVITATION_NOT_FOUND' | 'INVITATION_NOT_PENDING' | 'INVALID_ROLE' | 'PLAN_LIMIT_EXCEEDED';
    /**
     ...
     */
    type LoginOutcome = 'success' | 'wrong_password' | 'disabled' | 'blocked' | 'requires_2fa' | 'wrong_totp' | 'totp_replay' | 'totp_locked';
    /**
 ...
 *   on the next sign-in.
 */
export declare const SIGN_IN_METHOD_ERROR_CODES: readonly ["SIGN_IN_METHOD_LAST_CREDENTIAL", "SIGN_IN_METHOD_NOT_LINKED", "SIGN_IN_METHOD_ALREADY_LINKED", "SIGN_IN_PROVIDER_REFUSED", "SIGN_IN_UID_MISMATCH", "SIGN_IN_IDENTITY_MISMATCH", "SIGN_IN_IDENTITY_UNVERIFIED", "INVALID_ID_TOKEN", "SIGN_IN_PROVIDER_UNSUPPORTED", "SIGN_IN_METHODS_CONFLICT", "SIGN_IN_RELAY_IDENTITY_UNRESOLVED"];
 ...
 * verify again.
 */
export declare const REFRESH_ERROR_CODES: readonly ["MISSING_REFRESH_TOKEN", "INVALID_REFRESH_TOKEN", "NOT_A_REFRESH_TOKEN", "LEGACY_STATELESS_TOKEN", "CSRF_ORIGIN_REJECTED", "REFRESH_TOKEN_UNKNOWN", "FAMILY_REVOKED", "SESSION_EXPIRED_ABSOLUTE", "CONCURRENT_ROTATION", "ACCOUNT_DISABLED", "USER_NOT_FOUND", "ROLE_NOT_ALLOWED"];
 ...
 */
export declare const STEP_UP_ERROR_CODES: readonly ["REQUIRES_2FA"];
 ...
 */
export declare const LOGIN_ERROR_CODES: readonly ["WRONG_CREDENTIALS", "ACCOUNT_LOCKED", "ACCOUNT_DISABLED", "CAPTCHA_REQUIRED", "CAPTCHA_INVALID", "ATTESTATION_REQUIRED", "ATTESTATION_INVALID", "ROLE_NOT_ALLOWED"];
/**
 ...
 */
export declare const LOGIN_2FA_ERROR_CODES: readonly ["INVALID_2FA_CODE", "2FA_LOCKED"];
