 ...
 */
export declare const STOCK_ADJUSTMENT_REASONS: readonly ["count_correction", "shrinkage", "breakage", "found"];
/**
 ...
 */
export declare const STOCK_INCOME_ADJUSTMENT_REASONS: readonly ["count_correction", "found"];
/**
 ...
 * cannot deplete.
 */
export declare const STOCK_SALE_ADJUSTMENT_REASONS: readonly ["count_correction", "shrinkage", "breakage"];
/**
 ...
 */
export declare const MAX_STOCK_ADJUSTMENT_NOTE_BYTES = 280;
declare global {
    interface StockBase {
        storeId: string;
        stockId: string;
     ...
     */
    type StockAdjustmentReason = "count_correction" | "shrinkage" | "breakage" | "found";
    ...
    type StockSaleAdjustmentReason = "count_correction" | "shrinkage" | "breakage";
