declare global {
     ...
     */
    type MlFiscalDocumentFailureKind = 'facturador-collision' | 'document-rejected' | 'connection' | 'ml-unavailable' | 'internal';
 ...
 * transition.
 */
export declare const ORDER_FULFILMENT_TRANSITIONS: Readonly<Record<OrderFulfilmentStatus, readonly OrderFulfilmentStatus[]>>;
/**
 ...
 */
export declare const ORDER_FINANCIAL_TRANSITIONS: Readonly<Record<OrderFinancialStatus, readonly OrderFinancialStatus[]>>;
/** Every fulfilment status, in lifecycle order. */
export declare const ORDER_FULFILMENT_STATUSES: [OrderFulfilmentStatus, ...OrderFulfilmentStatus[]];
/** Every financial status, from unpaid to settled. */
export declare const ORDER_FINANCIAL_STATUSES: [OrderFinancialStatus, ...OrderFinancialStatus[]];
export declare const isOrderFulfilmentStatus: (value: unknown) => value is OrderFulfilmentStatus;
export declare const isOrderFinancialStatus: (value: unknown) => value is OrderFinancialStatus;
/**
 ...
 * assume it.
 */
export declare const ORDER_FULFILMENT_TERMINAL_STATUSES: readonly OrderFulfilmentStatus[];
