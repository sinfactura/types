 ...
 */
export declare const LABEL_TEMPLATE_IDS: readonly ["producto", "precio", "estante", "envio", "inventario"];
...
declare global {
     ...
     */
    type PrintPrinterReport = Omit<PrintPrinter, 'agentId' | 'active' | 'reportedAt' | 'online' | 'rawFormats' | 'columns' | 'imageMode' | 'qrMode' | 'drawerKick'>;
    /**
