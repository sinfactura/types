declare global {
    ...
    type StorefrontEvent = ProductViewedEvent | ProductListViewedEvent | CartItemAddedEvent | CartItemRemovedEvent | CartViewedEvent | SearchSubmittedEvent | CheckoutStartedEvent | CheckoutStepCompletedEvent | PaymentInfoEnteredEvent | OrderCompletedEvent | OrderCancelledByCustomerEvent | CustomerLoggedInEvent | CustomerSignedUpEvent | CustomerLoggedOutEvent | CustomerIdentifiedEvent | CustomerPasswordResetRequestedEvent | NotificationMarkedReadEvent | NotificationsMarkedAllReadEvent | SurveySubmittedEvent | CustomerProfileUpdatedEvent | CustomerPasswordChangedEvent;
