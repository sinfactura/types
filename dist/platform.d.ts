...
export type PlatformOAuthAppConfigResponse = {
    data: PlatformOAuthAppConfig[];
};
 ...
 */
export type TenantBillingHistoryError = 'BILLING_NOT_CONFIGURED' | 'EXTERNAL_RESOURCE_NOT_FOUND' | 'INVALID_PROVIDER' | 'PROVIDER_UNAVAILABLE';
/**
 ...
 */
export type CatalogWarningCode = 'NUMERIC_MISMATCH' | 'UNLIMITED_ADVERTISED_AS_CAPPED' | 'UNBACKED_CAPABILITY' | 'MISSING_FEATURE_ROW';
/**
