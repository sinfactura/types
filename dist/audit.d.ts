declare global {
    ...
    interface FiscalAuditEvent {
         ...
         */
        operation: 'FECAESolicitar' | 'FECompConsultar' | 'FEXAuthorize' | 'ConstatarComprobante' | 'ConsultarApoc' | 'FECAEASolicitar' | 'FECAEARegInformativo' | 'FECAEASinMovimientoConsultar' | 'FECAEASinMovimientoInformar' | 'aceptarFECred' | 'rechazarFECred';
