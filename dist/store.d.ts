...
declare global {
     ...
     */
    interface StoreUpdateInput extends Partial<Omit<Store, 'photoData' | 'removePhotoURL' | 'config'>> {
        /**
     ...
     */
    type DomainVerifyFailureReason = "TXT_NOT_FOUND" | "NO_PENDING_REGISTRATION" | "NOT_OWNER" | "TOKEN_MISMATCH" | "NOT_PENDING";
    /**
    ...
    type DomainVerifyResult = {
        ...
        verified: false;
        reason: DomainVerifyFailureReason;
    };
    /**
     ...
     */
    type DomainErrorCode = "DOMAIN_LIMIT_REACHED" | "DOMAIN_OWNED_BY_OTHER_STORE" | "DOMAIN_NOT_CLAIMABLE" | "NOT_OWNER";
}
export {};
